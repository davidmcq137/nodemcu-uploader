...
print("A")
print(lib.unpack('<i4', string.char(10, 0, 0, 1)))
print(10 + 2^(3*8))

--assert(lib.unpack('>i4', string.char(0, 1, 0, 10)) == 10 + 2^(2*8))
print("B")
print(lib.unpack('>i4', string.char(0, 1, 0, 10)))
print(10 + 2^(2*8))

print("C")
print(lib.unpack('<i4', string.char(256-10, 256-1, 256-1, 256-1)))
print(-10)
...
for _, a in pairs{'', '>', '<'} do
  for _, l in pairs(lims) do
    local fmt = a .. l[1]
    r1,r2=lib.unpack(fmt, lib.pack(fmt, l[2]))
    print(r1, r2, l[2])
    --assert(r1==l[2])
  end
end
...
-- tests for long long
if true then -- lib.unpack("i8", string.rep("\255", 8)) ~= -1 then
