set -e
set -x
~/NodeMCU/nodemcu-firmware/luac.cross -o ./LFS.img -f medidoSPISUI.lua bleSPI.lua adc1115.lua mcp23008.lua LFS_dummy_strings.lua
#
...
python nodemcu-uploader.py --port /dev/ttyUSB0 --baud 115200 upload _xinitSW.lua:init.lua
...
python nodemcu-uploader.py --port /dev/ttyUSB0 --baud 115200 upload start2.lua:start2.lua
