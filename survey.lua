...
local function send_survey_datapoint_request(survey_url, entry_key, data)
  return make_http_request("POST", survey_url, {["Content-Type"] = "application/x-www-form-urlencoded"}, (entry_key .. "=" .. data))
end
local function do_http_request(host, body)
